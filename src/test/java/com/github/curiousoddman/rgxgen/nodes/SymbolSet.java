...
public class SymbolSet extends Node {
    ...
    public static SymbolSet ofDotPattern(RgxGenProperties properties) {
        ...
        // MODIFIED: Always use full Unicode range for dot pattern to cover all possible characters
    ...
    public static SymbolSet ofAsciiCharacters(String pattern, char[] symbols, MatchType type) {
        return new SymbolSet(pattern, emptyList(), CharList.charList(symbols), type, UNICODE_SYMBOL_RANGE);
    }
    ...
    public static SymbolSet ofAscii(String pattern, List<SymbolRange> symbolRanges, CharList charList, MatchType type) {
        return new SymbolSet(pattern, symbolRanges, charList, type, UNICODE_SYMBOL_RANGE);
    }

    public static SymbolSet ofAsciiRanges(String pattern, List<SymbolRange> symbolRanges, MatchType type) {
        return new SymbolSet(pattern, symbolRanges, CharList.empty(), type, UNICODE_SYMBOL_RANGE);
    }
    ...
    public SymbolSet getInvertedNode() {
        // MODIFIED: always use the full Unicode ranges for inverted sets to cover all possible characters
