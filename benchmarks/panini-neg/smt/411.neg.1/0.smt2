; Input: /Users/paul/Workspace/flat-checker/benchmarks/panini-neg/py/411.neg.1.py
(set-logic ALL)
(declare-const s String)
(declare-const i@1 Int)
(assert (let ((_let_1 (re.range "a" "b"))) (str.in_re s (re.++ (re.* _let_1) (re.++ (re.diff re.allchar _let_1) (re.* re.allchar))))))
